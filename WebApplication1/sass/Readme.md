...
folder are mapped to the application's root namespace, 'WebApplication1'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'WebApplication1' in the same way
as `"WebApplication1/sass/src"`.
